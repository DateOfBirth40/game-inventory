...
async function gameCopyCreate(index, game, platform, condition) {
  ...
  console.log(`Added game copy: ${game.title}: ${condition}`);
}
...
// index, title, publisher, summary, locationCity, locationCountry, founded
...
async function createGameCopies() {
  ...
  await Promise.all([
    gameCopyCreate(0, games[0], platforms[0], "New"),
    gameCopyCreate(1, games[0], platforms[0], "Used"),
    gameCopyCreate(2, games[1], platforms[1], "Used"),
    gameCopyCreate(3, games[1], platforms[3], "Used"),
    gameCopyCreate(4, games[1], platforms[2], "New"),
    gameCopyCreate(5, games[2], platforms[1], "Used"),
    gameCopyCreate(6, games[3], platforms[3], "Used"),
    gameCopyCreate(7, games[3], platforms[5], "Used"),
    gameCopyCreate(8, games[4], platforms[0], "Used"),
    gameCopyCreate(9, games[4], platforms[0], "New"),
    gameCopyCreate(10, games[6], platforms[1], "Used"),
    gameCopyCreate(11, games[6], platforms[2], "Used"),
    gameCopyCreate(12, games[6], platforms[4], "New"),
    gameCopyCreate(13, games[7], platforms[1], "New"),
    gameCopyCreate(14, games[7], platforms[2], "Used"),
    gameCopyCreate(15, games[7], platforms[4], "New"),
    gameCopyCreate(16, games[8], platforms[2], "New"),
    gameCopyCreate(17, games[8], platforms[4], "Used"),
    gameCopyCreate(18, games[8], platforms[5], "New"),
  ]);
}
